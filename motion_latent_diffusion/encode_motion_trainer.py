...
# from modules.model_VAE_1 import TransformerMotionAutoencoder
# from modules.model_VAE_2 import TransformerMotionAutoencoder_Chunked as TransformerMotionAutoencoder


if model == 'VAE1':
    from modules.motion_VAE_1 import TransformerMotionAutoencoder
    cfg = config = load_config('motion_VAE1')
    from modules.data_modules import MotionDataModule1 as MotionDataModule
elif model == 'VAE2':
    from modules.motion_VAE_2 import TransformerMotionAutoencoder_Chunked as TransformerMotionAutoencoder
    cfg = config = load_config('motion_VAE2')
    from modules.data_modules import MotionDataModule1 as MotionDataModule
elif model == 'VAE3':
    from modules.motion_VAE_3_text import TransformerMotionAutoencoder
    cfg = config = load_config('motion_VAE3')
    from modules.data_modules import MotionDataModule2 as MotionDataModule
...
if __name__ == "__main__":
    logger = TensorBoardLogger("logs/encode_motion/", name="TransformerMotionAutoencoder1")
